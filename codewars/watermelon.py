...
that each of the two parts consists of an even number of watermelons. However,
...
out, whether they can divide the fruits in the way they want. For sure,
...
"""
def divide(weight):
    return True if (weight % 2 == 0 and weight != 2) else False
"""
